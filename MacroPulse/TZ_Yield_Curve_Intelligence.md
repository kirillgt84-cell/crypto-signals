...
### 1.1 Назначение
Модуль **Yield Curve Intelligence (YCI)** — это расширение Mirkaso Dashboard для анализа кривых доходности казначейских облигаций США (Treasury Yield Curve) и прогнозирования их влияния на глобальные рынки: акции, индексы, FOREX, криптовалюты, сырьевые товары.
...
Модуль **Yield Curve Intelligence** станет ключевым инструментом макро-анализа в экосистеме Mirkaso. Историческая ретроспектива 100+ лет и автоматический поиск аналогий позволят:
